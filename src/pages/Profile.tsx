...
//       try {
//         const response = await fetch(`http://192.168.0.111:10000/doctors/profile/${user.doctor_id}`, {
//           headers: {
...
export const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        const response = await fetch(`http://192.168.0.111:10000/doctors/profile/${doctorId}`, {
          headers: {
            'Authorization': `Bearer ${user.token}`
          }
        });
